...
public class DataSourceConfig {
    ...
    public DataSource itemDataSource() {
        return DataSourceBuilder.create()
                ...
                .url(jdbcSqlite + path.getDatabasePath() + "DATA_ITEM.db")
                .build();
    }
    ...
    public DataSource fluidDataSource() {
        return DataSourceBuilder.create()
                .driverClassName("org.sqlite.JDBC")
                .type(HikariDataSource.class)
                .url(jdbcSqlite + path.getDatabasePath() + "DATA_FLUID.db")
                .build();
    }
    ...
    public DataSource energyDataSource() {
        return DataSourceBuilder.create()
                .driverClassName("org.sqlite.JDBC")
                .type(HikariDataSource.class)
                .url(jdbcSqlite + path.getDatabasePath() + "DATA_ENERGY.db")
                .build();
    }

    @Bean(name = "itemJdbcTemplate")
    public JdbcTemplate itemJdbcTemplate(@Qualifier("itemDataSource") DataSource dataSource) {
        return new JdbcTemplate(dataSource);
    }

    @Bean(name = "fluidJdbcTemplate")
    public JdbcTemplate fluidJdbcTemplate(@Qualifier("fluidDataSource") DataSource dataSource) {
        return new JdbcTemplate(dataSource);
    }

    @Bean(name = "energyJdbcTemplate")
    public JdbcTemplate energyJdbcTemplate(@Qualifier("energyDataSource") DataSource dataSource) {
        return new JdbcTemplate(dataSource);
    }
}
